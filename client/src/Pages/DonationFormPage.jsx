    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {formSteps.map((step, index) => (
            <li
              ...
              className={`relative ${index !== 0 ? "pl-6 sm:pl-8" : ""} ${
                index !== formSteps.length - 1 ? "pr-6 sm:pr-8" : ""
              } flex-1`}
            >
              ...
              {index !== formSteps.length - 1 && (
                <div className="absolute top-4 right-0 hidden h-0.5 w-5 sm:w-10 bg-gray-200 sm:block" />
              )}
              {index !== 0 && (
                <div className="absolute top-4 left-0 hidden h-0.5 w-5 sm:w-10 bg-gray-200 sm:block" />
              )}
            </li>
          ))}
        </ol>
      ...
      <div className="bg-white shadow-lg rounded-xl overflow-hidden transition-all duration-300">
        <form className="p-8">
          ...
          {currentStep === 1 && (
            <div className={`space-y-6 ${getStepAnimationClass()}`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
                <div
                  className={`border-2 p-6 rounded-lg cursor-pointer transition-all duration-300 transform hover:scale-[1.02] ${
                    donationType === "cash"
          ...
          {currentStep === 2 && (
            <div className={`space-y-8 ${getStepAnimationClass()}`}>
              <h2 className="text-lg font-medium text-gray-900">
                Donation Details
              </h2>
              <p className="text-sm text-gray-500">
                ...
                <div className="sm:col-span-3">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      id="donor_name"
                      {...register("donor_name")}
                      className="shadow-sm block w-full rounded-lg border border-gray-300 pl-11 pr-4 py-3 text-gray-900 placeholder:text-gray-400 focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm transition-colors duration-200"
                    ...
                    <input
                      ...
                      className={`shadow-sm block w-full rounded-lg border ${
                        errors.date_received
                          ? "border-red-300"
                          : "border-gray-300"
                      } pl-11 pr-4 py-3 text-gray-900 focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm transition-colors duration-200`}
                    />
                  </div>
                  {errors.date_received && (
                  ...
                  <div className="sm:col-span-3">
                    ...
                    <div className="relative">
                      ...
                      <select
                        ...
                        className="shadow-sm block w-full rounded-lg border border-gray-300 pl-11 pr-4 py-3 text-gray-900 focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm transition-colors duration-200"
                      >
                    ...
                    <textarea
                      ...
                      className={`shadow-sm block w-full rounded-lg border ${
                        errors.description
                          ? "border-red-300"
                          : "border-gray-300"
                      } pl-11 pr-4 py-3 text-gray-900 placeholder:text-gray-400 focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm transition-colors duration-200`}
                      placeholder={
                        donationType === "goods"
              ...
              <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-300">
                <div className="flex justify-between items-center mb-4 pb-4 border-b border-gray-100">
                  <h3 className="text-lg font-semibold text-gray-900 flex items-center">
                    <span className="inline-block p-2 bg-emerald-100 text-emerald-600 rounded-full mr-3">
                      {donationType === "cash" ? (
                ...
                <dl className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
                  <div className="relative group overflow-hidden transition-all duration-300 transform hover:translate-x-1 col-span-1">
                    ...
                    <dd className="text-base font-medium text-gray-900 truncate pr-10 pl-2">
                  ...
                  {donationType === "cash" && (
                    <div className="relative group overflow-hidden transition-all duration-300 transform hover:translate-x-1 col-span-1">
                      ...
                      <dd className="text-xl font-bold text-emerald-600 truncate pl-2">
                  ...
                  {donationType === "cash" && watchCampaign && (
                    <div className="relative group overflow-hidden transition-all duration-300 transform hover:translate-x-1 col-span-1">
                      ...
                      <dd className="text-base font-medium text-gray-900 truncate pl-2">
                        {campaigns.find((c) => c.id === watchCampaign)?.title ||
                          "No Campaign"}
                      </dd>
                      <div className="absolute inset-0 border-l-2 border-transparent group-hover:border-emerald-500 opacity-0 group-hover:opacity-100 transition-all duration-300"></div>
                    </div>
                  ...
                  {watchDescription && (
                    <div className="col-span-full mt-2 relative group overflow-hidden">
                      <dt className="text-sm font-medium text-gray-500 mb-1 flex items-center">
                        <DocumentTextIcon className="h-4 w-4 mr-1 text-gray-400" />
                        Description
                      </dt>
                      <dd className="text-sm text-gray-700 bg-gray-50 p-3 rounded border border-gray-100 group-hover:border-emerald-200 transition-colors duration-200">
                        {watchDescription}
                      </dd>
                    </div>
                  )}
          ...
          {/* Navigation Buttons */}
          <div className="flex justify-between space-x-4 pt-8 border-t mt-8">
            {currentStep > 1 ? (
              <button
                type="button"
                onClick={prevStep}
                className="group relative bg-white py-3 px-6 border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 transition-all duration-200 overflow-hidden"
              >
                <span className="absolute inset-y-0 left-0 flex items-center justify-center w-10 bg-gray-100 group-hover:bg-gray-200 transition-all duration-200 transform -translate-x-10 group-hover:translate-x-0">
                  <svg
              ...
              <button
                type="button"
                onClick={() => navigate("/")}
                className="group relative bg-white py-3 px-6 border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 transition-all duration-200"
              >
                <span className="relative inline-flex items-center">
                  <svg
                    className="mr-2 h-4 w-4 text-gray-500 group-hover:text-gray-700 transition-colors duration-200"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
            ...
            {currentStep < formSteps.length ? (
              ...
              >
                ...
                <span className="absolute inset-y-0 right-0 flex items-center justify-center w-10 transform translate-x-10 group-hover:translate-x-0 transition-transform duration-200">
                  <svg
              ...
              >
                {loading ? (
                  ...
                  <span className="inline-flex items-center">
                    ...
                    <svg
                      className="ml-2 -mr-1 h-4 w-4 text-white group-hover:translate-x-1 transition-transform duration-200"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
