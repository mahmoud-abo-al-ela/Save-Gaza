  ...
  return (
    <div className="space-y-6">
      <div className="sm:flex sm:items-center sm:justify-between">
        ...
        <div className="mt-4 sm:mt-0 flex space-x-3">
          ...
          >
            {viewMode === "table" ? (
              <>
                <ViewColumnsIcon className="-ml-1 mr-2 h-5 w-5 text-gray-500" />
                Card View
              </>
            ) : (
              <>
      ...
      {filteredDonations.length === 0 ? (
        <div className="bg-white shadow rounded-lg p-8 text-center animate-fadeIn">
                ...
                currentDonations.map((donation) => (
                  ...
                  >
                    ...
                    <div className="p-5">
                      ...
                      {donation.donation_type === "cash" && (
                        <div className="mt-3 mb-4 text-center py-3 px-2 bg-gray-50 rounded-lg">
                      ...
                      {donation.donation_type === "goods" && (
                        <div className="mt-3 mb-4 py-3 px-3 bg-gray-50 rounded-lg">
                      ...
                      <div className="border-t border-gray-100 pt-4 grid grid-cols-2 gap-x-4 gap-y-3">
                        ...
                        <div>
                          ...
                          <div className="flex items-center mt-1">
                            <BuildingLibraryIcon className="flex-shrink-0 mr-1.5 h-4 w-4 text-gray-400" />
              ...
              {loadingDetails ? (
                ...
                <>
                  ...
                  <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                    <Link
                      to={`/donations/edit/${donationDetails._id}`}
